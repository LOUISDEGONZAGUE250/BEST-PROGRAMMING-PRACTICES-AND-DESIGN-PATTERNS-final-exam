                ...
                <?php foreach ($tours as $tour): ?>
                    <div class="tour-card">
                        ...
                        <div class="tour-info">
                            ...
                            <div>
                                <span>Max: <?php echo htmlspecialchars($tour['max_participants'] ?? 'N/A'); ?></span> | <span><?php echo htmlspecialchars($tour['location'] ?? 'N/A'); ?></span> | <span><?php echo htmlspecialchars($tour['category'] ?? 'N/A'); ?></span>
                            </div>
                            <div>
                                <span class="availability-badge" style="<?php echo ($tour['availability'] ?? 0) ? 'background:#e8f5e9;color:#2e7d32;' : 'background:#ffebee;color:#c62828;'; ?>">
                                    <?php echo ($tour['availability'] ?? 0) ? 'Available' : 'Unavailable'; ?>
                                </span>
                            </div>
    ...
    <div id="editModal" class="modal">
        <div class="modal-content">
            ...
            <form method="POST" enctype="multipart/form-data" id="editTourForm">
                ...
                <div class="form-group">
                    <label>Image</label>
                    <input type="file" name="image" accept="image/*" onchange="previewImage(this, 'editImagePreview')">
